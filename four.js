...
function Gameboard() {
  ...
  // It is helpful to see what the board looks like after each turn as we play, but we won't need it after we build our UI
  const printBoard = () => {
...
function GameController(
  ...
  // For the console version, we will only use playRound, but we will need getActivePlayer for the UI version, so I'm revealing it now
  return {
    playRound,
    getActivePlayer,
  };
